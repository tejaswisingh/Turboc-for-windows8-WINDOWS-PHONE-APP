...
namespace WPAppStudio.Services
{
    ...
    public class NavigationService : ServicesInterfaces.INavigationService
    {
        ...
        {
            { typeof(IViewModels.IWhoWeAre_TutorialViewModel), "/View/WhoWeAre_Tutorial.xaml" },
            { typeof(IViewModels.Imoments_DetailViewModel), "/View/moments_Detail.xaml" },
            { typeof(IViewModels.IPhotoAlbum_DetailViewModel), "/View/PhotoAlbum_Detail.xaml" },
            { typeof(IViewModels.IWhoWeAre_DetailViewModel), "/View/WhoWeAre_Detail.xaml" },
