...
namespace WPAppStudio.ViewModel
{
    ...
    {       
        ...
        {
			_title = @"TurboC++";
			_description = @"This is a tutorial to install Turboc++ in windows 8 operating system as we know these days engineers need turboc++ to practice the programs , so here is the tutorial for you guys."; 
			_version = "v1";
			_appLink = "https://apps.windowsstore.com/DashBoard/DownloadAppXap?appId=a89a8634-521e-4218-86ee-9ae677eb871b";
