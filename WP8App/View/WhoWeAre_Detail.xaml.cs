...
{
    /// <summary>
    /// Phone application page for WhoWeAre_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class WhoWeAre_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for WhoWeAre_Detail and all its components.
        /// </summary>
        public WhoWeAre_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaWhoWeAre_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaWhoWeAre_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaWhoWeAre_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaWhoWeAre_Detail(PanoramaWhoWeAre_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaWhoWeAre_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IWhoWeAre_WhoWeAreCollection>();
				AddHomeAppBarButton();
				...
				((IViewModels.IWhoWeAre_DetailViewModel)DataContext).CurrentWhoWeAreSchema = pinnedItem;				
			}
		}
