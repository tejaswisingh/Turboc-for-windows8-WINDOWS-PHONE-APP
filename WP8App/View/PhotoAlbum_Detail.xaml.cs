...
namespace WPAppStudio.View
{
    ...
    {       
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IPhotoAlbum_PhotoAlbumCollection>();
				AddHomeAppBarButton();
				...
				((IViewModels.IPhotoAlbum_DetailViewModel)DataContext).CurrentPhotoAlbumCollectionSchema = pinnedItem;				
			}
		}
