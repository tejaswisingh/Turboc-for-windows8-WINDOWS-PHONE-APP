...
{
    /// <summary>
    /// Fake PhotoAlbumCollectionSchema data source.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class FakePhotoAlbum_PhotoAlbumCollection : IPhotoAlbum_PhotoAlbumCollection 
    {
        ...
        /// </summary>
        /// <returns>An observable collection of Entities.PhotoAlbumCollectionSchema items.</returns>
		
        public async Task<ObservableCollection<Entities.PhotoAlbumCollectionSchema>> GetData(int pageNumber = 0)
		{
			return await Task.Factory.StartNew(()=>new ObservableCollection<Entities.PhotoAlbumCollectionSchema>(new ObservableCollection<Entities.PhotoAlbumCollectionSchema>().Skip(MaxResults*pageNumber).Take(MaxResults)) 
	
			{ 
				new Entities.PhotoAlbumCollectionSchema()
				{
		...
		{
			return await Task.Factory.StartNew(()=>new ObservableCollection<Entities.PhotoAlbumCollectionSchema>(new ObservableCollection<Entities.PhotoAlbumCollectionSchema>().Take(MaxResults)) 
        ...
        {
            var data = new List<Entities.PhotoAlbumCollectionSchema>();
